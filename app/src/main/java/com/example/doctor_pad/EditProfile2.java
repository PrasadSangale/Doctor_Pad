...
public class EditProfile2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileName= findViewById(R.id.namecamefromfirestore);
...
//        Log.d(TAG, "onCreate: "+phonenocamefromfirestore+"*************************************************");
        ...
        DocumentReference documentReference=fstore.collection("Doctor").document(str);
        ...
        homebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent hoo=new Intent(EditProfile2.this,PatientHomePage.class);
                startActivity(hoo);
            }
        });
        ...
        finddoctor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent foo=new Intent(EditProfile2.this,AvailableDoctors.class);
                startActivity(foo);
            }
        });
        ...
        fprofile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent poo=new Intent(EditProfile2.this,EditProfile.class);
                startActivity(poo);
            }
        });
