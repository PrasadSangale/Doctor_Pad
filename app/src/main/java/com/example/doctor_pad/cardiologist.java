...
public class cardiologist extends AppCompatActivity {
    ...
    int imgs[] = { R.drawable.prasad,R.drawable.jaydeep,R.drawable.smit, R.drawable.shikha,
            R.drawable.seema,R.drawable.harsh,R.drawable.maya
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doctor_name = getResources().getStringArray(R.array.cardio_names);
        description = getResources().getStringArray(R.array.cardiologist);
        ...
        homebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent hoo=new Intent(cardiologist.this,PatientHomePage.class);
                startActivity(hoo);
            }
        });
        ...
        finddoctor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent foo=new Intent(cardiologist.this,AvailableDoctors.class);
                startActivity(foo);
            }
        });
        ...
        fprofile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent poo=new Intent(cardiologist.this,EditProfile.class);
                startActivity(poo);
            }
        });
        ...
        flogout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(cardiologist.this);
